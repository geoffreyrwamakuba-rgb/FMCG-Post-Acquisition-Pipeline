...
base_path = f's3://sportsbar-gr/{data_source}'
...
if csv_files:
    ...
    print("No CSV files found — skipping load.")
    dbutils.notebook.exit("No data — pipeline stopped.")

# COMMAND ----------

# DBTITLE 1,Write Delta Table
# Important to append to bronze table so old data is kept
df.write\
 .format("delta") \
